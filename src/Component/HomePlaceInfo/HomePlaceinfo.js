...
import BookingNav from "../../Layot/BookinLayot/BookingNav/BookingNav";
              ...
              <div className="relative  ">
                <Autocomplete>
                  <input
                    ...
                    className="border border-gray-400 rounded-sm  text-black   px-16 py-5  text-md     bg-white w-full"
                  ...
                  <div className="relative   ">
                    <Autocomplete>
                      <input
                        ...
                        className="border border-gray-400 rounded-sm text-black   px-16 py-2  text-md   bg-white w-full"
              ...
              <div className="relative  ">
                <Autocomplete>
                  <input
                    ...
                    className="border bg-white border-gray-400 text-black  rounded-sm   px-16 py-5  text-md    w-full"
